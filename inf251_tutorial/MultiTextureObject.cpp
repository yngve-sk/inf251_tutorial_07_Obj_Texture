...
void MultiTextureObject::drawObject() {
...
void MultiTextureObject::drawMesh(int numberOfIndices, GLuint startIndex, GLuint texture, GLuint &VBO, GLuint &IBO, GLuint posLoc, GLuint texLoc, GLuint normalLoc) {
