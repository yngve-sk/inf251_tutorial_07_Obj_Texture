...
void SingleTextureObject::loadMaterials(const char* TextureDirectory) {
...
void SingleTextureObject::loadMaterial(const char* TextureDirectory, GLuint &TextureObject, int i, const ModelOBJ::Material &material) {
...
void SingleTextureObject::drawMesh(int numberOfIndices, GLuint startIndex, GLuint texture, GLuint &VBO, GLuint &IBO, VertexGLLocs vertexGLLocs) {
